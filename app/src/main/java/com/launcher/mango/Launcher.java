...
import com.launcher.mango.LauncherSettings.Favorites;
import com.launcher.mango.Workspace.ItemOperator;
import com.launcher.mango.accessibility.LauncherAccessibilityDelegate;
import com.launcher.mango.allapps.AllAppsContainerView;
import com.launcher.mango.allapps.AllAppsTransitionController;
import com.launcher.mango.anim.AnimationLayerSet;
import com.launcher.mango.compat.AppWidgetManagerCompat;
import com.launcher.mango.compat.LauncherAppsCompat;
import com.launcher.mango.compat.LauncherAppsCompatVO;
import com.launcher.mango.compat.UserManagerCompat;
import com.launcher.mango.config.FeatureFlags;
import com.launcher.mango.dragndrop.DragController;
import com.launcher.mango.dragndrop.DragLayer;
import com.launcher.mango.dragndrop.DragOptions;
import com.launcher.mango.dragndrop.DragView;
import com.launcher.mango.dragndrop.PinItemDragListener;
import com.launcher.mango.dynamicui.ExtractedColors;
import com.launcher.mango.dynamicui.WallpaperColorInfo;
import com.launcher.mango.folder.Folder;
import com.launcher.mango.folder.FolderIcon;
import com.launcher.mango.keyboard.CustomActionsPopup;
import com.launcher.mango.keyboard.ViewGroupFocusHelper;
import com.launcher.mango.logging.FileLog;
import com.launcher.mango.logging.UserEventDispatcher;
import com.launcher.mango.model.ModelWriter;
import com.launcher.mango.model.PackageItemInfo;
import com.launcher.mango.model.WidgetItem;
import com.launcher.mango.notification.NotificationListener;
import com.launcher.mango.pageindicators.PageIndicator;
import com.launcher.mango.popup.PopupContainerWithArrow;
import com.launcher.mango.popup.PopupDataProvider;
...
import com.launcher.mango.util.Thunk;
...
import com.launcher.mango.widget.WidgetAddFlowHandler;
...
public class Launcher extends BaseActivity
    ...
    public void bindItems(final List<ItemInfo> items, final boolean forceAnimateIcons) {
        Runnable r = () -> bindItems(items, forceAnimateIcons);
        if (waitUntilResume(r)) {
            return;
        }
            ...
            switch (item.itemType) {
                ...
                case LauncherSettings.Favorites.ITEM_TYPE_DEEP_SHORTCUT: {
                    ...
                    if (item instanceof AppInfo) {
                        info = new ShortcutInfo((AppInfo) item);
                    } else {
    ...
    /**
     * $ adb shell dumpsys activity com.launcher.mango.Launcher [--all]
     */
    @Override
