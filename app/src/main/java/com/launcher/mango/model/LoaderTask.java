...
import com.launcher.mango.FolderInfo;
import com.launcher.mango.IconCache;
import com.launcher.mango.InstallShortcutReceiver;
...
import com.launcher.mango.ShortcutInfo;
...
import com.launcher.mango.compat.PackageInstallerCompat;
...
import com.launcher.mango.folder.FolderIconPreviewVerifier;
...
public class LoaderTask implements Runnable {
    ...
    public void run() {
        ...
        try (LauncherModel.LoaderTransaction transaction = mApp.getModel().beginLoader(this)) {
            ...
            boolean standard = !LauncherStyle.isDrawer(mApp.getContext());
            if (standard) {
                if (DEBUG_LOADERS) Log.d(TAG, "step 2.4: binding all apps to screen");
                verifyNotStopped();
                mResults.bindAllAppsToScreen();
            }
